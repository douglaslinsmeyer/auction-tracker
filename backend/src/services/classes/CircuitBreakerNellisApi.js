...
class CircuitBreakerNellisApi {
  constructor(nellisApi) {
    ...
    this._config = {
      ...
      timeout: parseInt(process.env.CIRCUIT_BREAKER_TIMEOUT, 10) || 60000, // 1 minute
      halfOpenRetryDelay: parseInt(process.env.CIRCUIT_BREAKER_RETRY_DELAY, 10) || 10000, // 10 seconds
      successThreshold: parseInt(process.env.CIRCUIT_BREAKER_SUCCESS_THRESHOLD, 10) || 3
    };
   ...
   */
  _onSuccess(operation, duration, _context) {
